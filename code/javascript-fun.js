...
/* ========= CODE MENU ============= */
const codeListBtn = document.getElementById("code-list");
const codeNav = document.getElementById("code-nav");

codeListBtn.addEventListener("click", toggleCodeMenu);
codeNav.addEventListener("click", toggleCodeMenu);

function toggleCodeMenu() {
  codeNav.classList.toggle("mobile-code-nav");
}
...
let guessInput = document.getElementById("numberGuessInput");
let randomNumber = 0;
